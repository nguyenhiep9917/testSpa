                    ...
                    <div id="page-wrapper">
                        ...
                        <div class="container-fluid" style="background-color: white; margin: 0 5;">
                            <div class="col-lg-12">
                                ...
                                <form enctype="multipart/form-data" action="{{ url('/admin/tintuc/quanlytin/them')}}" method="POST">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="cmsnews_title" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label>Mô tả ngắn</label><br>
                                        <textarea name="cmsnews_shortcontent" class="form-control"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Mô tả</label><br>
                                        <textarea name="cmsnews_fullcontent" class="form-control " id="editor1"></textarea>
                                    </div>
