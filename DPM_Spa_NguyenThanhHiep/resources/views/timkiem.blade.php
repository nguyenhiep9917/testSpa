...
<div class="container">
    ...
    <div class="box-item box-merchandise">
        <h5 class="title"><label style="font-size: 18px; margin-left: 10px;">Kết quả tìm được {{count($data)}} sản phẩm</label><a class="all-btn" href="#">Trở về <i class="fa fa-chevron-right"></i></a></h5>
        <div class="">
