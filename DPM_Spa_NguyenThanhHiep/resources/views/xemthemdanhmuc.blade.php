...
<div class="container">
 <p><hr></p>
    <div class="box-item box-merchandise dmnganhhang">
        <h6 class="title"><label style="font-size: 18px; margin-left: 10px;">DANH MỤC NGÀNH HÀNG</label><a class="all-btn" href="#">Trở về <i class="fa fa-chevron-right"></i></a></h6>
        <div class="">
           ...
           <div class="row">
                <div class="phantrang">{{$data_Catalogy -> links()}}</div>
            </div> 
        </div>
    </div>
</div> 
